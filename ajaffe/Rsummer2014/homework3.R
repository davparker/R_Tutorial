...
# Instructions: 
# 1)	Get the dataset: http://biostat.jhsph.edu/~ajaffe/files/kaggleCarAuction.csv
# 2)	Read the "dictionary": http://biostat.jhsph.edu/~ajaffe/files/Carvana_Data_Dictionary.txt
...
# Questions
# 1)	Read in the dataset itself, naming the R object "cars", and the data dictionary, naming it "key", into R (as separate objects). Save them together in an ".rda" file so you can access the data offline. 
